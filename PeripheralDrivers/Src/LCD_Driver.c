...
void LCD_writeData(I2C_Handler_t *ptrHandlerI2C, uint8_t dataToWrite){
	...
	//Se envía la dirección del esclavo y la señal de escribir
	i2c_sendSlaveAddressRW(ptrHandlerI2C, ptrHandlerI2C->slaveAddres, I2C_WRITE_DATA);

	//Se envía la dirección de la memoria a escribir
